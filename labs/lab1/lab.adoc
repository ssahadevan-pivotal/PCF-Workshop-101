...
. You may download to any directory. Make a note of the directory you downloaded the directory PCF-Workshop-101 to.

. Example - If you downloaded files to /temp, then there should be a directory /temp/PCF-Workshop-101. This directory is referred to as $BOOTCAMP_HOME
...
====
----
Using manifest file cf-spring-mvc-boot/manifest.yml <1>

Creating app workshop in org groupX / space development as userX@client.com ...
OK <2>
...
Uploading app files from: Workshop-101/cf-spring-mvc-boot/target/cf-spring-mvc-boot-0.0.1-SNAPSHOT.jar
Uploading 10.6M, 153 files
Done uploading               
OK

Starting app workshop in org groupX / space hopper as userX@client.com ... <6>
